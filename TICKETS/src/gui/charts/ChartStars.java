...
/**
 *
 * Klasse erstellt ein 3D Diagramm zur Beliebtheit von Filmen
 * 
 * 
 * @author Soeren Kroell, Mareike Schulz, Sebastian Fuchs
 * @version 28.02.2012
 */
public class ChartStars extends JFrame{
    ...
    public ChartStars(String filmtitel, String bezeichnung1, String bezeichnung2, String bezeichnung3, String bezeichnung4, int wert1, int wert2, int wert3, int wert4){
    ...
    public BufferedImage makeChart(){
        ...
        dataset.setValue(bezeichnung3+" ("+wert3+"%)", wert3);
        dataset.setValue(bezeichnung4+" ("+wert4+"%)", wert4);
        
        JFreeChart chart3 = ChartFactory.createPieChart3D("Beliebheit des Films: "+filmtitel, dataset, true, false, false);
